...
ALLOWED_HOSTS = ['shop-project-sportswear.herokuapp.com', 'localhost']
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'shop-project-sportswear'
...
DEFAULT_FROM_EMAIL = 'shopprojectsportswear@example.com'
